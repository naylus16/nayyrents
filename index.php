...
<div id="carouselId" class="carousel slide" data-ride="carousel">
    ...
    <div class="carousel-inner" role="listbox">
        ...
        <div class="carousel-item <?php if($no == '1'){ echo 'active';}?>">
            <img src="assets/image/nay.png?= $isi['gambar'];?>" 
           class="img-fluid" style="object-fit:cover;width:100%;height:650px;">
        </div>
        <?php $no++;}?>
    </div>
        ...
        <div class="col-sm-5">
            <div class="card" style=" background: #ddd">
                <div class="card-body">
                    ...
                    <?php }else{?>
                    <form class="align-items: center" method="post" action="koneksi/proses.php?id=login">
